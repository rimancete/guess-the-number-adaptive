...
Este projeto é um mini-game de advinhação de número, para estudo / prática de conceitos relacionado a desenvolvimento mobile, especificamente React Native.
